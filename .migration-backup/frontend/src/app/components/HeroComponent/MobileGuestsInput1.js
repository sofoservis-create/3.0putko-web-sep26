            ...
            >
              ...
              {!!totalGuests && open && (
                <button
                  ...
                  className="absolute z-[9] flex items-center justify-center w-5 h-5 text-sm transform -translate-y-1/2 rounded-full lg:w-6 lg:h-6 bg-neutral-200 right-1 lg:right-3 top-1/2"
                >
