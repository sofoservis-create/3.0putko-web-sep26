          ...
          <div className="bg-[#FFFEF9] p-6 sm:p-10 lg:p-12">
            ...
            <div className="mt-6 lg:mt-8">
              ...
              <p className="mt-2 font-inter text-sm md:text-base text-[#4A5568] text-center lg:text-left">
                {t.WelcomebackPleaseenteryourdetails}
              </p>
            </div>
            ...
            <div className="mt-8 space-y-5 w-full max-w-md mx-auto lg:mx-0">
              ...
              <button
                ...
                className="flex w-full items-center justify-center rounded-xl bg-[#238869] px-4 py-3 font-inter text-[16px] font-medium leading-[30px] text-white transition hover:bg-[#1d6f56] focus:outline-none focus:ring-2 focus:ring-[#238869]/40"
              >
