...
export default function Home() {
  ...
  const structuredData = {
    ...
    description:
      "Discover and book unique stays including glamping, cabins, treehouses, farm stays and apartments with Putko.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Book glamping, cabins, treehouses and unique accommodations",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Rent apartments and vacation homes worldwide",
          },
        },
      ],
    },
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Booking is simple! Just search for your location and dates, choose a property, and complete your booking. You will get instant confirmation."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "We accept major credit cards (Visa, Mastercard, Amex), PayPal, and bank transfers for selected properties."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Cancellation policies depend on the property. Many offer free cancellation up to 24 hours before check-in."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Yes, browsing and searching properties is completely free. The price you see is final with no hidden fees."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Click 'List your property', create an account, and submit your listing. Our team will verify and publish it."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text":
            "Support is available 24/7 via live chat, email at support@putko.sk, or phone."
        }
      }
    ]
  };
  ...
  return (
    <>
      ...
      <main className="lg:pt-5">
        ...
        {/* Everything below hero gets background */}
        <div className="bg-[#FFFEF9]">
          ...
          {/* Why Putko benefits */}
          <div className="bg-white py-8 lg:py-14 px-4 lg:px-5">
