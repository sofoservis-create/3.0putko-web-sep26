...
const ReservationList = () => {
    ...
    const { data, loading, error } = useFetchData(`${process.env.NEXT_PUBLIC_BASE_URL}/reservation`);
    ...
    const handleSendPaymentEmail = async (reservationId) => {
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/payments/send-payment-email`, {
                method: "POST",
