...
export const pageSeoConfig = {
  ...
  profile: {
    title: 'Your Profile - Putko',
    description: 'Manage your Putko profile, view bookings, and update your travel preferences.',
    keywords: ['user profile', 'account settings', 'travel preferences', 'booking history'],
    openGraph: {
      title: 'Your Profile - Putko',
      description: 'Manage your Putko profile, view bookings, and update your travel preferences.',
    },
