...
export const destinations: Destination[] = [
  ...
  item("vysoke-tatry", "Vysoké Tatry", "High Tatras", "mountains", null, 3, 49.1717, 20.1300, 35),
  item("strbske-pleso", "Štrbské Pleso", "Štrbské Pleso", "nature", "vysoke-tatry", 4, 49.1192, 20.0632, 8),
  item("poprad", "Poprad", "Poprad", "city", "vysoke-tatry", 5, 49.0554, 20.3014, 15, "/poprad.avif"),
  item("liptov", "Liptov", "Liptov", "region", null, 6, 49.0167, 19.5833, 42),
  item("liptovsky-mikulas", "Liptovský Mikuláš", "Liptovský Mikuláš", "city", "liptov", 7, 49.0811, 19.6192, 15),
  item("ruzomberok", "Ružomberok", "Ružomberok", "city", "liptov", 8, 49.0748, 19.3075, 16, "/Ružomberok.avif"),
  item("nizke-tatry", "Nízke Tatry", "Low Tatras", "mountains", null, 9, 48.9469, 19.5894, 45),
  item("jasna", "Jasná", "Jasná", "nature", "nizke-tatry", 10, 48.9715, 19.5841, 12),
  item("horehronie", "Horehronie", "Horehronie", "region", null, 11, 48.8077, 19.6394, 43),
  item("slovensky-raj", "Slovenský raj", "Slovak Paradise", "nature", null, 12, 48.9365, 20.4098, 28),
  item("spisska-nova-ves", "Spišská Nová Ves", "Spišská Nová Ves", "city", "slovensky-raj", 13, 48.9446, 20.5615, 16, "/Spišská-Nová-Ves.avif"),
  item("banska-stiavnica", "Banská Štiavnica", "Banská Štiavnica", "landmark", null, 14, 48.4589, 18.8964, 18),
  ...
  item("mala-fatra", "Malá Fatra", "Malá Fatra", "mountains", null, 17, 49.2020, 19.0500, 35),
  item("terchova", "Terchová", "Terchová", "nature", "mala-fatra", 18, 49.2589, 19.0294, 16),
  item("orava", "Orava", "Orava", "region", null, 19, 49.3000, 19.5500, 48),
  item("oravsky-hrad", "Oravský hrad", "Orava Castle", "landmark", "orava", 20, 49.2619, 19.3585, 16),
  item("pieniny", "Pieniny", "Pieniny", "nature", null, 21, 49.4000, 20.4500, 27),
  item("bardejov", "Bardejov", "Bardejov", "city", null, 22, 49.2920, 21.2753, 16, "/Bardejov.avif"),
  item("bardejovske-kupele", "Bardejovské Kúpele", "Bardejov Spa", "spa", "bardejov", 23, 49.3291, 21.2711, 8),
  item("piestany", "Piešťany", "Piešťany", "spa", null, 24, 48.5918, 17.8272, 14),
  item("trencianske-teplice", "Trenčianske Teplice", "Trenčianske Teplice", "spa", null, 25, 48.9097, 18.1669, 12),
  item("bojnice", "Bojnice", "Bojnice", "landmark", null, 26, 48.7797, 18.5773, 14),
  ...
  item("velka-fatra", "Veľká Fatra", "Veľká Fatra", "mountains", null, 31, 48.9500, 19.0800, 36),
  item("muranska-planina", "Muránska planina", "Muráň Plateau", "nature", null, 32, 48.7700, 20.0300, 30),
