...
export default function RefundDialog({ reservation, onClose, onDone }) {
  ...
  useEffect(() => {
    ...
    apiFetch(`${(import.meta.env.VITE_API_URL || "https://backend-9k3q.onrender.com/api")}/cancellation/preview/${reservation._id}`, {
  ...
  const submit = async () => {
    ...
    try {
      const res = await apiFetch(
        `${(import.meta.env.VITE_API_URL || "https://backend-9k3q.onrender.com/api")}/cancellation/${reservation._id}`,
        {
          method: "POST",
          reservationId: reservation._id,
