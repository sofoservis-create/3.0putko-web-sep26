...
const NcInputNumber = ({
  ...
  return (
    ...
    >
      ...
      >
        <button
          className="w-11 h-11 -my-1.5 -ml-1.5 rounded-full flex items-center justify-center border border-[#357965] bg-white focus:outline-none hover:border-neutral-500 disabled:hover:border-neutral-400 disabled:opacity-50 disabled:cursor-default"
          type="button"
        ...
        />
        <button
          className="w-11 h-11 -my-1.5 -mr-1.5 rounded-full flex items-center justify-center border border-[#357965] bg-white focus:outline-none hover:border-neutral-500 disabled:hover:border-neutral-400 disabled:opacity-50 disabled:cursor-default"
          type="button"
