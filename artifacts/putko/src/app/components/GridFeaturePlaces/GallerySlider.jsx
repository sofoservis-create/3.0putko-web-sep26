      ...
      <div className={`relative group group/cardGallerySlider ${className}`} {...handlers}>
        ...
        {navigation && (
          <div className="transition-opacity duration-200 opacity-0 group-hover/cardGallerySlider:opacity-100">
            {index > 0 && (
              <button
                className="absolute flex items-center justify-center w-11 h-11 -translate-y-1/2 bg-white border rounded-full left-1.5 top-1/2 border-neutral-200 hover:border-neutral-300"
            ...
            {index + 1 < images.length && (
              <button
                className="absolute flex items-center justify-center w-11 h-11 -translate-y-1/2 bg-white border rounded-full right-1.5 top-1/2 border-neutral-200 hover:border-neutral-300"
            ...
            return images.slice(start, end).map((_, i) => {
              ...
              return (
                <button
                  ...
                  aria-current={actualIndex === index ? "true" : undefined}
                />
              );
            });
          })()}
