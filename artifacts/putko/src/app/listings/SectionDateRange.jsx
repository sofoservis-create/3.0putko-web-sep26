...
const SectionDateRange = ({ data }) => {
  ...
  return (
    <div
      id="date-section"
      className="overflow-hidden section-date-range w-full bg-transparent md:bg-white md:rounded-2xl border-t border-neutral-200/70 md:border border-0 md:shadow-xs pt-4 md:p-8 font-inter antialiased space-y-4 sm:space-y-6"
    >
      {/* SECTION HEADER */}
          ...
          renderDayContents={(day, date) => {
            ...
            return (
              <div
                className={
                  isDisabled
                    ? "listing-date-status--unavailable"
                    : isPast
                      ? "listing-date-status--past"
                      : "listing-date-status--available"
                }
      ...
      <div className="pt-5 border-t border-neutral-100">
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 text-sm">
          ...
          <div className="inline-flex items-center gap-2.5 bg-neutral-50/70 border border-neutral-100 rounded-xl px-3 py-2">
            <div className="listing-date-status--unavailable">
              <span className="listing-date-unavailable-swatch">15</span>
            </div>
          ...
          {/* Selected Dates */}
          <div className="inline-flex items-center gap-2.5 bg-neutral-50/70 border border-neutral-100 rounded-xl px-3 py-2">
            <div className="w-7 h-7 rounded-full bg-[#319a7a] flex items-center justify-center text-xs font-semibold text-white shadow-3xs">
              <span>17</span>
            </div>
