...
function ClientPage({ accommodation, userAccommodations, host, reviewsRating, secondaryLoading = false }) {
  ...
  const renderSection1 = () => {
    ...
    return (
      ...
      <div className="w-full bg-transparent sm:bg-white rounded-2xl border-0 sm:border border-neutral-200/80 sm:shadow-xs p-0 sm:p-6 md:p-8 font-inter antialiased">
        ...
        <div className="space-y-2.5 pb-4 sm:pb-5 border-b border-neutral-100">
        ...
        <div className="py-4 sm:py-5 border-b border-neutral-100">

          {/* DESKTOP VIEWPORT: Clean Grid Specs Layout */}
          <div className="hidden lg:grid grid-cols-4 gap-2 text-neutral-800">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">{t.guests || "Hostia"}</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">{t.bedrooms || "Spálne"}</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">{t.Bathroom || "Kúpeľňa"}</span>
            ...
            {kitchen > 0 || SocialRoom > 0 ? (
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col min-w-0">
                  <span className="text-xs text-neutral-400 font-semibold uppercase tracking-wider">Vybavenie</span>
          ...
          {/* MOBILE/TABLET VIEWPORT: Horizontal Swipeable Snapping Cards */}
          <div className="flex lg:hidden overflow-x-auto snap-x snap-mandatory gap-2 pb-4 -mx-5 px-5 sm:-mx-6 sm:px-6 md:-mx-8 md:px-8 no-scrollbar">

            <div className="snap-start flex min-h-16 w-[102px] shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200/60 bg-white px-2 py-2.5 shadow-3xs sm:w-[132px] sm:gap-2 sm:px-3" aria-label={`${person} ${t.guests || "Hostia"}`}>
               <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1e4636]/5 text-[#319a7a]">
                 <User size={14} strokeWidth={2} />
               </div>
               <div className="min-w-0 text-left">
                 <div className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">{t.guests || "Hostia"}</div>
                 <div className="text-xs sm:text-sm font-bold text-neutral-900 truncate">{person}</div>
               </div>
            </div>

            <div className="snap-start flex min-h-16 w-[102px] shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200/60 bg-white px-2 py-2.5 shadow-3xs sm:w-[132px] sm:gap-2 sm:px-3" aria-label={`${bedroom} ${t.bedrooms || "Spálne"}`}>
               <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1e4636]/5 text-[#319a7a]">
                 <DoorOpen size={14} strokeWidth={2} />
               </div>
               <div className="min-w-0 text-left">
                 <div className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">{t.bedrooms || "Spálne"}</div>
                 <div className="text-xs sm:text-sm font-bold text-neutral-900 truncate">{bedroom}</div>
               </div>
            </div>

            <div className="snap-start flex min-h-16 w-[102px] shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200/60 bg-white px-2 py-2.5 shadow-3xs sm:w-[132px] sm:gap-2 sm:px-3" aria-label={`${totalbath} Kúpeľňa, ${WCs} WC`}>
               <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1e4636]/5 text-[#319a7a]">
                 <Layers size={14} strokeWidth={2} />
               </div>
               <div className="min-w-0 text-left">
                 <div className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">{t.Bathroom || "Kúpeľňa"}</div>
                 <div className="text-xs sm:text-sm font-bold text-neutral-900 truncate">
                   {totalbath} <span className="text-[11px] sm:text-xs text-neutral-400 font-normal">({WCs} WC)</span>
                 </div>
               </div>
            </div>

            {kitchen > 0 && (
              <div className="snap-start flex min-h-16 w-[102px] shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200/60 bg-white px-2 py-2.5 shadow-3xs sm:w-[132px] sm:gap-2 sm:px-3" aria-label={t.Kitchen || "Kuchyňa"}>
                 <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1e4636]/5 text-[#319a7a]">
                   <Utensils size={14} strokeWidth={2} />
                 </div>
                 <div className="min-w-0 text-left">
                   <div className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">Vybavenie</div>
                   <div className="text-xs sm:text-sm font-bold text-neutral-900 truncate">{t.Kitchen || "Kuchyňa"}</div>
                 </div>
              </div>
            )}

            {SocialRoom > 0 && (
              <div className="snap-start flex min-h-16 w-[102px] shrink-0 items-center gap-1.5 rounded-xl border border-neutral-200/60 bg-white px-2 py-2.5 shadow-3xs sm:w-[132px] sm:gap-2 sm:px-3" aria-label={t.SocialRoom || "Spoločenská"}>
                 <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#1e4636]/5 text-[#319a7a]">
                   <Users size={14} strokeWidth={2} />
                 </div>
                 <div className="min-w-0 text-left">
                   <div className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">Vybavenie</div>
                   <div className="text-xs sm:text-sm font-bold text-neutral-900 truncate">{t.SocialRoom || "Spoločenská"}</div>
                 </div>
              </div>
            )}
          ...
          {/* MOBILE/TABLET VIEWPORT: Check-in / Check-out Boxes */}
          <div className="lg:hidden mt-2">
            <ModalMobileSelectionDate
              renderChildren={({ openModal }) => (
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={openModal}
                    className="flex min-w-0 flex-1 flex-col items-start rounded-xl border border-neutral-200/80 bg-neutral-50/50 px-4 py-3 text-left transition-colors hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-[#319a7a]"
                  >
                    <span className="mb-1 text-[11px] font-bold uppercase tracking-wider text-neutral-500">
                      {language === "en" ? "Check-in" : "Príchod"}
                    </span>
                    <span className={`truncate text-sm font-bold ${startdate ? "text-[#1e4636]" : "text-neutral-400"}`}>
                      {startdate ? format(new Date(startdate), "dd.MM.yyyy") : t.SelectDate || "Vyberte dátum"}
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <span className="mb-1 text-[11px] font-bold uppercase tracking-wider text-neutral-500">
                      {language === "en" ? "Check-out" : "Odchod"}
                    </span>
                    <span className={`truncate text-sm font-bold ${enddate ? "text-[#1e4636]" : "text-neutral-400"}`}>
                      {enddate ? format(new Date(enddate), "dd.MM.yyyy") : t.SelectDate || "Vyberte dátum"}
                    </span>
                  </button>
                </div>
              )}
              ...
              guestValues={mobileGuestValues}
              onGuestsChange={handleMobileGuestsChange}
              capacity={accommodationData?.person}
            />
          </div>
          ...
          <div className="relative overflow-hidden w-full bg-emerald-50/60 border border-emerald-100 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 transition-all duration-300 hover:shadow-2xs">
            ...
            <div className="bg-white border border-emerald-100 rounded-lg px-3 py-1.5 shadow-3xs flex items-center justify-between sm:justify-start gap-4 z-10">
              ...
              <div className="text-right">
                ...
                <span className="text-xs text-neutral-500 font-medium"> / {t.night}</span>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="md:col-span-7 flex flex-col justify-between space-y-4 md:space-y-0">
              ...
              <div className="space-y-3.5">
                <div className="space-y-0.5">
                  <span className="text-[11px] text-[#319a7a] font-bold uppercase tracking-widest block">
                    {propertyType || "Ubytovanie"}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-3 max-w-sm text-xs sm:text-sm">
                  <div className="flex flex-col p-2.5 bg-neutral-50/80 rounded-xl border border-neutral-100/70">
                    <span className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">{t.Totalcapacity}</span>
                    <span className="font-bold text-neutral-800 mt-0.5">{person} {t.Guests}</span>
                  </div>

                  <div className="flex flex-col p-2.5 bg-neutral-50/80 rounded-xl border border-neutral-100/70">
                    <span className="text-[11px] text-neutral-400 font-bold uppercase tracking-wider">Dispozícia spální</span>
                ...
                <div className="flex flex-wrap gap-1.5 pt-0.5">
                  {doublebed > 0 && (
                    <span className="inline-flex items-center text-xs font-semibold text-neutral-600 bg-neutral-100 px-3 py-1.5 rounded-md">
              ...
              <div className="pt-2 md:pt-0">
                <button
                  className="inline-flex items-center justify-center min-h-[44px] gap-1.5 text-sm font-bold text-[#319a7a] bg-[#319a7a]/5 hover:bg-[#319a7a]/10 border border-[#319a7a]/20 rounded-lg px-4 transition-all active:scale-98"
                  onClick={openModalDetails}
                >
                  <Wifi size={16} strokeWidth={2.5} />
                  <span>{t.Showdetails}</span>
                  <ChevronDown size={16} strokeWidth={2.5} className="text-[#319a7a]/70" />
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/60 backdrop-blur-xs p-4">
            <Dialog.Panel className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden transform transition-all border border-neutral-100 max-h-[90vh] flex flex-col">
              ...
              <div className="flex items-center justify-between p-5 border-b border-neutral-100 bg-white shrink-0">
                <div className="space-y-0.5">
                  <span className="text-[11px] font-bold text-[#319a7a] uppercase tracking-wider">{propertyType}</span>
                ...
                <button
                  ...
                  className="w-11 h-11 rounded-full bg-neutral-50 border border-neutral-200/60 flex items-center justify-center text-neutral-400 hover:text-neutral-700 hover:bg-neutral-100 text-xl font-light transition-all"
                  aria-label="Close"
                >
                  &times;
                </button>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    ...
                    {LivingRoom > 0 && (
                      <li className="p-3 bg-white border border-neutral-200/80 rounded-xl flex items-center justify-between">
                        ...
                        <span className="bg-neutral-100 text-neutral-800 px-2.5 py-1 rounded-md text-xs font-bold">{LivingRoom}x</span>
                      </li>
                    )}
                    ...
                    {kitchen > 0 && (
                      <li className="p-3 bg-white border border-neutral-200/80 rounded-xl flex items-center justify-between">
                        ...
                        <span className="bg-neutral-100 text-neutral-800 px-2.5 py-1 rounded-md text-xs font-bold">{kitchen}x</span>
                      </li>
                    )}
                    ...
                    {SocialRoom > 0 && (
                      <li className="p-3 bg-white border border-neutral-200/80 rounded-xl flex items-center justify-between">
                        ...
                        <span className="bg-neutral-100 text-neutral-800 px-2.5 py-1 rounded-md text-xs font-bold">{SocialRoom}x</span>
                      </li>
                    )}
                    ...
                    {bath > 0 && (
                      <li className="p-3 bg-white border border-neutral-200/80 rounded-xl flex items-center justify-between">
                        ...
                        <span className="bg-neutral-100 text-neutral-800 px-2.5 py-1 rounded-md text-xs font-bold">{bath}x</span>
                      </li>
                    )}
                    ...
                    {WCs > 0 && (
                      <li className="p-3 bg-white border border-neutral-200/80 rounded-xl flex items-center justify-between">
                        ...
                        <span className="bg-neutral-100 text-neutral-800 px-2.5 py-1 rounded-md text-xs font-bold">{WCs}x</span>
                      </li>
                    )}
                  </ul>
                </div>
 ...
 const renderSection3 = () => {
        ...
        {allAmenities.length > 12 && (
          <div className="pt-3">
            <button
              ...
              className="inline-flex items-center justify-center min-h-[44px] text-sm font-bold text-neutral-700 bg-white hover:bg-neutral-50 border border-neutral-200 hover:border-neutral-300 rounded-xl px-5 transition-all shadow-3xs active:scale-98"
            >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/60 backdrop-blur-xs p-4 animate-fade-in">
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden transform transition-all border border-neutral-100 max-h-[85vh] flex flex-col">
              ...
              <div className="p-4 bg-neutral-50 border-t border-neutral-100 flex justify-end shrink-0">
                <button
                  onClick={closeModalAmenities}
                  className="inline-flex items-center justify-center min-h-[44px] text-sm font-bold text-neutral-600 bg-white border border-neutral-200 rounded-lg px-5 hover:bg-neutral-50 transition-all"
                >
                  Zavrieť
                </button>
              </div>
  ...
  const renderSection44 = () => {
    ...
    if (!pricePerNight && validFlexiblePrices.length === 0) {
      return (
        <div className="w-full bg-transparent sm:bg-white sm:rounded-2xl border-t sm:border border-neutral-200/80 sm:shadow-xs pt-4 sm:p-6 md:p-8 font-inter antialiased space-y-4 sm:space-y-5">
          <div className="space-y-1">
            <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1e4636] font-fraunces">
              {t.RoomRates}
            </h2>
        ...
        <div className="relative z-0 aspect-square overflow-hidden rounded-2xl border border-neutral-200/70 bg-neutral-100 shadow-3xs sm:aspect-[5/3]">
          {googleMapsApiKey ? (
            <>
              ...
              <iframe
                title={`${t.Location}: ${displayLocation}`}
                loading="lazy"
                allowFullScreen
            ...
            <div className="flex h-full w-full flex-col items-center justify-center gap-3 px-6 text-center text-neutral-500">
              ...
              <p className="text-sm font-medium">
                {language === "sk"
                  ? "Mapa momentálne nie je dostupná."
    ...
    <>
      ...
      <div className="lg:pt-24 nc-ListingStayDetailPage">
        ...
        <main className="relative z-10 mt-6 flex flex-col px-4 sm:px-0 lg:mt-11 lg:flex-row">
          ...
          {/* CONTENT */}
          <div className="w-full space-y-4 sm:space-y-8 lg:w-3/5 xl:w-2/3 lg:space-y-10 lg:pr-10">
