...
const MobileFooterSticky = () => {
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 z-40 block bg-white/95 backdrop-blur-md shadow-[0_-4px_24px_rgba(0,0,0,0.06)] border-t border-neutral-100 lg:hidden transition-all duration-300">
