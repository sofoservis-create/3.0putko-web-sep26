...
export default function SharedModal({
  ...
  const filteredImages = useMemo(() => {
    return images?.filter((img) => img.id >= index - 15 && img.id <= index + 15);
  }, [index, images]);
  ...
  return (
    ...
    >
      <div
        className="relative z-50 flex aspect-[3/2] w-full max-w-7xl items-center wide:h-full xl:taller-than-854:h-auto max-h-screen p-4 md:p-0"
        {...handlers}
      >
        {/* Main image */}
            ...
            <AnimatePresence initial={false} custom={direction}>
              ...
              >
                <img
                  ...
                  fetchPriority="high"     // browser-level priority (very important)
                  decoding="async"
        ...
        <div className="hidden">
          {images?.[index + 1]?.url && (
            <img
              ...
              height="853"
              alt="preload next"
              loading="eager"     // same intent as priority
              decoding="async"
              fetchPriority="high" // closest equivalent to priority
              sizes="1px"
            />
          )}
          {images?.[index - 1]?.url && (
