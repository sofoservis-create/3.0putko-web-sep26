...
const PaymentSuccessContent = () => {
    ...
    useEffect(() => {
        ...
        const poll = async () => {
            try {
                const res = await fetch(`${(import.meta.env.VITE_API_URL || "https://backend-9k3q.onrender.com/api")}/payments/verify-payment`, {
                    method: "POST",
                    ...
                    {status === "success" && reservationId && (
                        <a
                            ...
                            href={withReservationToken(
                                `${(import.meta.env.VITE_API_URL || "https://backend-9k3q.onrender.com/api")}/receipts/${reservationId}?lang=${language}`,
                                reservationId
                            )}
